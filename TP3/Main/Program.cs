...
using Excepciones;
using Archivos;
using EntidadesAbstractas  = ClaseAbstracta;
...
namespace Main
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Alumno a1 = new Alumno(1, "Juan", "Lopez [ALUMNO]", "12234456", EntidadesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.Programacion, Alumno.EEstadoCuenta.Becado);
            uni += a1;
            try
            {
